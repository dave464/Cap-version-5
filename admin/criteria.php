            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Criteria</h3>
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action ="add_query_criteria.php?admin_id=<?php echo $fetch['admin_id']?>" method = "POST"  enctype="multipart/form-data">
         
           <input type="hidden" value="<?php echo $fetch['admin_id']?>" name="admin_id">

           <input type="hidden" value="<?php echo $fetch['criteria_id']?>" name="criteria_id">
            ...
            <div class = "form-group">
              ...
              <?php
                $query =  $conn->query("SELECT * FROM criteria  ") or die(mysqli_error());
  ...
  <textarea class="form-control" name="c_name" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
  <label for="floatingTextarea2"></label>
            ...
            <br />
            <div class = "form-group">
              <button name = "add_criteria" class = "btn btn-info form-control" style="background:dodgerBlue;"><i class = ""></i> Saved</button>
            </div>
            <?php require_once 'add_query_criteria.php'?>
          </form>
        </div>
                                    ...
                                    <table id="table" class="table user-table">
                                        ...
                                        <tbody>
                                             <?php  
                                              ...
                                              ?>
                                            <tr>
                                                <td><?php echo $fetch['criteria_id']?></td>
                                                <td><?php echo $fetch['c_name']?></td>
                                               
                                                <td><a class = "btn btn-danger" href="delete_criteria.php?criteria_id=<?php echo $fetch['criteria_id']?>" onclick = "confirmationDelete(this); return false;"
