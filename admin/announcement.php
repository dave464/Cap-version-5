            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Announcement</h3>
                    ...
                    <div class="card-body p-md-5">
                      <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                          ...
                          <div class="form-floating" style=" border:.5px solid dodgerBlue;box-shadow: 0 0 8px 0 dodgerBlue">
                            <textarea class="form-control" name="message" placeholder="Leave a comment here"
                             ...
                             <label for="floatingTextarea2">Make an announcement.</label>
                           </div>
                            <div>
                                <button name = "announcement" class = "btn btn-primary" 
                                        style="background:dodgerBlue; 
                                 margin-left:385px; margin-top:30px;">
                                 <i class = ""></i> Submit
                                </button> 
                             </div> 
                          </form>
                        ...
                        <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                            <img src="megaphone.png" class="img-fluid" alt="Sample image">
                        </div>
                      </div>
                    </div>
                  </div>
